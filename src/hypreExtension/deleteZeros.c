...
HYPRE_Int hypre_DropSmallEntries(hypre_ParCSRMatrix *A, double tol)
{
   ...
   marker_offd = parelag_hypre_CTAlloc(HYPRE_Int, num_cols_A_offd);
   ...
   parelag_hypre_TFree(marker_offd);
