...
#ifndef PARELAG_AMSSOLVERFACTORY_HPP_
#define PARELAG_AMSSOLVERFACTORY_HPP_
...
/** \class AMSSolverFactory
 *  \brief Constructs AMSSolverWrapper objects.
 */
class AMSSolverFactory : public SolverFactory
{
public:
     ...
     */
    AMSSolverFactory(ParameterList const& pl = ParameterList())
    { SetParameters(pl); }
...
#endif /* PARELAG_AMSSOLVERFACTORY_HPP_ */
