...
#include "linalg/sparse_direct/ParELAG_SuperLUDistSolver_impl.hpp"

namespace parelag
{

// This is really the only meaningful instantiation for now...
template class SuperLUDistSolver<double>;

#ifdef PARELAG_ENABLE_COMPLEX
template class SuperLUDistSolver<std::complex<double>>;

// If users *happen* to magically already be using SLU types
template class SuperLUDistSolver<SLU::DCX::doublecomplex>>;
