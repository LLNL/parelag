...
#ifndef _1FORM_HELPERS_HPP__
#define _1FORM_HELPERS_HPP__
...
std::unique_ptr<ParameterList> Create1FormTestParameters()
{
    ...
    // Preconditioner Library
    {
        ...
        // PCG with Auxiliary Space Preconditioner
        {
            ...
            list.Set("Type", "Krylov");
            {
                ...
                solver_list.Set("Preconditioner", "AMGe-HIP-GS_1");
        ...
        // AMGe-HIP-GS_1
        {
            auto& list = prec_lib.Sublist("AMGe-HIP-GS_1");
            list.Set("Type", "AMGe");
            {
                auto& solver_list = list.Sublist("Solver Parameters");
        ...
        // PCG-AMS
        {
            auto& list = prec_lib.Sublist("PCG-AMS");
            list.Set("Type", "Krylov");
            {
                auto& solver_list = list.Sublist("Solver Parameters");
                solver_list.Set("Solver name", "PCG");
                solver_list.Set("Preconditioner", "AMS Solver");
                solver_list.Set("Print level", -1);
        ...
        // AMS Solver
        {
            auto& list = prec_lib.Sublist("AMS Solver");
            list.Set("Type", "AMS");
            {
                auto& solver_list = list.Sublist("Solver Parameters");
                solver_list.Set("Cycle type", 13);
                ...
                solver_list.Set("Beta is zero", false);
                {
                    auto& sub_solver_list =
                        solver_list.Sublist("PtAP AMG Parameters");

                    sub_solver_list.Set("Coarsening type", 10);
                    sub_solver_list.Set("Aggressive coarsening levels", 1);
                    sub_solver_list.Set("Relaxation type", 8);
                ...
                {
                    auto& sub_solver_list =
                        solver_list.Sublist("GtAG AMG Parameters");
